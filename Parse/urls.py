...
urlpatterns = [
    ...
    url(r'^favicon\.ico$', RedirectView.as_view(url='/media/logo2.ico')),
    path('users_search', user_views.users_search, name='users_search'),
    path('select_location/', lambda request: render(request, 'blog/temp.html'))
]
